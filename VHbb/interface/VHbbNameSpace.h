...
double SoverSBWeight(double BDT, int channel) {
 ...
 double SoverSBWeight_VZ(double BDT, int channel) {
    ...
    binBoundaries.insert(std::pair<int, std::vector<double> > (1, {-0.8, -0.7964, -0.6686000000000001, -0.5408000000000001, -0.41300000000000003, -0.2852, -0.1574000000000001, -0.02960000000000007, 0.09819999999999995, 0.22599999999999998, 0.3537999999999999, 0.48160000000000003, 0.6093999999999999, 0.7407999999999999, 0.8685999999999998, 1.0} ));  //bins['zeelow']

    binBoundaries.insert(std::pair<int, std::vector<double> > (2, {-0.8, -0.7964, -0.6722, -0.548, -0.42380000000000007, -0.2996000000000001, -0.1754000000000001, -0.05120000000000002, 0.07299999999999995, 0.19719999999999993, 0.3213999999999999, 0.4456, 0.5697999999999999, 0.7011999999999998, 0.8253999999999999, 1.0} ));  //bins['zuulow']

    binBoundaries.insert(std::pair<int, std::vector<double> > (3, {-0.8, -0.7766000000000001, -0.6596000000000001, -0.5426, -0.42560000000000003, -0.30860000000000004, -0.1916000000000001, -0.07460000000000011, 0.04239999999999988, 0.15939999999999988, 0.2764, 0.39339999999999997, 0.5104, 0.6399999999999999, 0.7569999999999999, 1.0} ));  //bins['zeehigh'

    binBoundaries.insert(std::pair<int, std::vector<double> > (4, {-0.8, -0.7964, -0.6776000000000001, -0.5588000000000001, -0.44000000000000006, -0.32120000000000004, -0.20240000000000002, -0.08360000000000012, 0.0351999999999999, 0.15399999999999991, 0.27279999999999993, 0.39159999999999995, 0.5104, 0.6436, 0.7624, 1.0} ));  //bins['zuuhigh'
    ...
    double SB_Zuu_low[nBins]={0.000044488502184739564, 
			      0.00029649100871548956, 
			      0.0009201810958585284, 
			      0.0016066423379721248, 
			      0.0028950795731256976, 
			      0.004134903391541092, 
			      0.0062762848083387, 
			      0.009604671157499913, 
			      0.014138042105016676, 
			      0.021066949772195805, 
			      0.034176274685107554, 
			      0.04951176273189254, 
			      0.07537928093659098, 
			      0.11575578259764387, 
			      0.16743353573335515
    ...
    double SB_Zee_low[nBins]={0.0002093144475949369, 
			      0.0005954847339052542, 
			      0.0009210055149576992, 
			      0.0014175050626033137, 
			      0.0029770671147323594, 
			      0.004509042207332993, 
			      0.007810157102722652, 
			      0.01202560316981223, 
			      0.016652303574890805, 
			      0.02328327194270849, 
			      0.037752499238423, 
			      0.06556187955627332, 
			      0.09162826576126447, 
    ...
    double SB_Zuu_high[nBins]={0.0, 
			       0.0001750859830053845, 
			       0.0017595256659878023, 
			       0.0019192645806335531, 
			       0.0046988530069383095, 
			       0.0071553146456622896, 
			       0.009724810160045887, 
			       0.009649462193646277, 
			       0.022804140043529673, 
			       0.034009348923916174, 
			       0.0486016790389434, 
			       0.09044530808765025, 
			       0.15778535043785816, 
			       0.18004758598610246, 
    ...
    double SB_Zee_high[nBins]={0.0, 
			       0.0016648443645934834, 
			       0.0017974214473611852, 
			       0.0022136470524553183, 
			       0.004174271316701445, 
			       0.006839182449399799, 
			       0.00924561429595096, 
			       0.01750461123132715, 
			       0.024268205732955263, 
			       0.049466887513391844, 
			       0.05345236266478544, 
			       0.09127800719624397, 
			       0.1508308039536669, 
			       0.20039091145300464, 
