...
class RegressionTrainer():
    ...
    def train(self):
        ...
        for iJet in range(0,2):
            ...
            fnameOutput='training_Reg_'+self.__title+'_Jet'+str(iJet)+'.root'
            ...
            factory.BookMethod(ROOT.TMVA.Types.kBDT,'BDT_REG_'+self.__title+'_Jet'+str(iJet), self.__regOptions)
