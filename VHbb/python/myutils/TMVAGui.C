...
// main GUI
void TMVAGui( const char* fName = "../../data/MVA_gg_plus_ZH125_tightHmass.root" ) 
{   
   ...
   //gROOT->SetMacroPath(curMacroPath+"/afs/cern.ch/sw/lcg/external/root/5.21.02/slc4_ia32_gcc34/root/tmva/test/");
