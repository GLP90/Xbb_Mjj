...
def drawFromDC():
    ...
    for dir in ROOT.gDirectory.GetListOfKeys():
        ...
        if 'Znn' in opts.bin:
            ...
            if not (dirinfo[0] == lep_channel and dirinfo[2] == region_name and dirinfo[3] == 'postfit'):
                continue
            else: print '!!! Match !!!'
        ...
        if 'Zuu' in opts.bin or 'Zee' in opts.bin:
            ...
            if not (dirinfo[0] == lep_channel and dirinfo[1] == region_name and dirinfo[2] == pt_region_name and dirinfo[3] == 'postfit'):
                continue
            else: print '!!! Match !!!'
